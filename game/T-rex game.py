...
bird1 = Image.open(r"C:\Users\User\Desktop\T-rex_ai\game\resources.png").crop((258,15,347,80)).convert("RGBA")
...
while playing:
    ...
    while not crashed:
       ...
       # gameDisplay.blit(pygame.image.fromstring(cloud.tobytes(), cloud.size, 'RGBA'), c4)
        gameDisplay.blit(pygame.image.fromstring(bird.tobytes(), bird.size, 'RGBA'), c3)
        c1 = (c1[0]-1, c1[1])
        c2 = (c2[0]-1, c2[1])
        c3 = (c3[0]-1, c3[1])
        c4 = (c4[0]-1, c4[1])
